...
get_header(); ?>
	...
	<div id="contact-right">
		...
		<script>
			//GOOGLE MAPS//
			var latlng = new google.maps.LatLng(34.172453,-79.816146);
			var options = {
			...
			var image = new google.maps.MarkerImage('/wp-content/themes/jessicacribb/images/map_pin.png',
 			...
 			var marker1 = new google.maps.Marker({
    		 	position: new google.maps.LatLng(34.172453,-79.816146),
    		 	map: map,
    		...
    		var infowindow1 = new google.maps.InfoWindow({
    		    content:  createInfo('<div id="bublble-title">The Mane Attraction Salon</div>', '<div id="bubble-addr-1">1001 S Cashua Drive</div><div id="bubble-addr-2">Florence, SC 29501</div><div id="bubble-phone">(843) 555-5555</div>')
    		});
